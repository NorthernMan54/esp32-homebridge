...
#define UI_COMP_HKBUTTONCONTAINER_CONTAINER2 4
#define UI_COMP_HKBUTTONCONTAINER_CONTAINER2_HKDISPLAYNAME 5
#define UI_COMP_HKBUTTONCONTAINER_CONTAINER2_HKSTATUS 6
